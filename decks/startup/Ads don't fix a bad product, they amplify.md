...
tags:
  - vocab-card
word: Ads don't fix a bad product, they amplify a good one.
type: sentence
category: startup
ipa: ""
meaning_en: Paid advertising cannot save a product nobody wants; it only scales up something that already works organically.
meaning_vi: Quảng cáo không cứu được sản phẩm tệ — nó chỉ khuếch đại thứ vốn đã tốt sẵn.
collocations:
  - amplify a good product
...
> [!quote] Ngữ cảnh
> But if it's good, it can help you reach and attract a bigger audience. Ads don't fix a bad product, they amplify a good one.
